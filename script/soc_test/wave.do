...
add wave -noupdate /tb_soc_top/u_SoC_top/u_AXI_APB_Bridge/APB_Master/*
add wave -noupdate /tb_soc_top/u_SoC_top/u_APB_Interconnect/*
add wave -noupdate /tb_soc_top/u_SoC_top/u_Bus_Access/*
add wave -noupdate /tb_soc_top/u_SoC_top/u_Bus_Access/AXI_Lite_Master/*
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {320292 ps} 0}
...
update
WaveRestoreZoom {0 ps} {431668 ps}
