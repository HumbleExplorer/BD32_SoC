...
`define BLOCK_ADDR_WIDTH 16
`define BOOT_BASE_ADDR 'h0000
`define ITCM_BASE_ADDR 'h0001
`define DTCM_BASE_ADDR 'h0002
`define CLINT_BASE_ADDR 'h0200
`define PLIC_BASE_ADDR 'h0C00
`define BUS_BASE_ADDR 'h8000
`define GPIO_BASE_ADDR 'h8000
`define UART_BASE_ADDR 'h8001
`define SPI_BASE_ADDR 'h8002
`define I2C_BASE_ADDR 'h8003
`define TIMER_BASE_ADDR 'h8004

`define FLASH_BASE_ADDR 'h8200
`define FLASH_LENGTH 128*1024*1024/8//128Mbit/8=16MB
`define DDR_BASE_ADDR (FLASH_BASE_ADDR+FLASH_LENGTH)//'h8400
